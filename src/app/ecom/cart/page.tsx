                    ...
                    <div className="mt-8">
                        <ul className="space-y-4">
                            <li className="flex items-center gap-4">
                                ...
                                <div>
                                    <h3 className="text-sm text-gray-900">Jewelry</h3>
                            ...
                            <div className="w-screen max-w-lg space-y-4">
                                ...
                                <div className="flex justify-end">
                                    ...
                                    >
                                        ...
                                        <p className="Purplespace-nowrap text-xs">2 Discounts Applied</p>
                                    </span>
                                </div>

                                <div className="flex justify-end">
                                    <a
                                        href="/ecom/cart/checkout"
